...
@Component({
  selector: 'app-git-search-pager',
  templateUrl: './git-search-pager.component.html',
  styleUrls: ['./git-search-pager.component.css']
})
export class GitSearchPagerComponent implements OnInit {
